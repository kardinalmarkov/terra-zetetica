...
const tasks = [
  ...
  { id: 37,  text: 'Создать «NearSky» стрим-камера на IPFS', time: '6 ч', complexity: 'hard', zeta: 15 },
  ...
  { id: 48,  text: 'Создать «путеводитель по зону TZ» в PDF', time: '3 ч', complexity: 'medium', zeta: 5 },
...
export default function GetInvolved() {
  return (
    <main className="wrapper" style={{ maxWidth: 960, margin: '0 auto', padding: '2rem 1rem' }}>
      ...
      // Внизу pages/get-involved.js, после таблицы и легенды
