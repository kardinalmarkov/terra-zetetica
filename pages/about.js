...
export default function About() {
  return (
      ...
      <div style={{ overflowX: 'auto' }}>
        <table className="growth-table" style={{ minWidth: '100%', borderCollapse: 'collapse' }}>
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              ...
              <td style={{ padding: '8px' }}>
                ...
                — 10+ анклавов;<br />
                — 100 000 граждан;<br />
                — первые участки, начало автономий в 5+ странах.
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style={{ padding: '8px' }}>
                📍 2040 год<br />
                — 100 000 анклавов;<br />
                — 250 миллионов граждан;<br />
                — суммарная площадь: 1,5 миллиона гектаров.
              </td>
            </tr>
          </tbody>
        </table>
