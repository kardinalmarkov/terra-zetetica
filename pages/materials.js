  ...
  return (
    <>
      ...
      <main className="wrapper" style={{ maxWidth: 960, margin: '0 auto', padding: '2rem 1rem' }}>
        ...
        <p>
          Материалы в процессе наполнения и классификации. Ниже — по одному примеру из каждой категории. Для полного архива переходите по ссылке
        ...
        <p style={{ fontStyle: 'italic', fontSize: '0.95rem', color: '#666' }}>
          ❗Внимание: поиск работает по кнопке 🔍 (лупа), не Enter. Возможны сбои. Настройте поисковые
          источники в разделе "Настройки" поисковика вверху справа. Рекомендуем: отключить Google, включить Mojeek
