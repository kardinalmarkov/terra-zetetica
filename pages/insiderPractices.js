...
<div style={{
  ...
  <h3 style={{ fontWeight: 700, marginBottom: '0.75rem' }}>📜 Итог от Инсайдера</h3>
  <p style={{ fontStyle: 'italic', marginBottom: '0.5rem' }}>
    Ответы — не в тексте, а в энергии твоих собственных шагов. 
    Не просто читай — проживай.
  </p>
  <p>
    🔍 <strong>Наблюдай мысль</strong> → 
    🧭 <strong>Выбирай полярность</strong> → 
    🛤️ <strong>Действуй</strong> → 
    🙏 <strong>Благодарись</strong>
  </p>
  <p style={{ marginTop: '1rem' }}>
    В этом — путь к <em>«максимальному знанию мироустройства»</em>: знанию через живой, осознанный опыт.
  </p>
</div>
