...
const allTasks = [
  ...
  { id: 2,  text: 'Создать группу TZ в VK и пригласить 20 человек', time: 60, complexity: 'medium', zeta: 5, checklist: [
      'Зарегистрироваться в VK',
      'Создать группу «Terra Zetetica»',
      'Пригласить друзей и опубликовать анонс'
    ]
  },
  // ... остальные задачи до 100
]
    ...
    <>
      ...
      <main className="wrapper">
              ...
              {filtered.filter(t => t.complexity===key).map(t => (
                <div key={t.id} className="task-card">
                  ...
                  <div className="task-meta">
                    <span>⏱ {t.time <= 60 ? `${t.time}′` : `${Math.floor(t.time/60)} ч`}</span>
        ...
        <section className="report">
          ...
          <form action="https://formspree.io/f/твой_формспри_ид" method="POST" className="report-form">
