...
export default function About() {
  return (
    ...
    >
      ...
      <p>
        <strong>Это реальное государство</strong>, основанное на Конституции, паспортной системе, DAO‑управлении, физической территориальной сетью анкла­вов и общностью мировоззрения. Наука больше не может быть догмой; Terra Zetetica утверждает право народа на наблюдение, логику и самостоятельное знание через <strong>зететическую методологию</strong>.
      </p>
