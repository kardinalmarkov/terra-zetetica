  ...
  return (
    ...
    >
      ...
      >
        ...
        <p>
          Государство Terra Zetetica открывает публичный вызов: <strong>научно докажите сферу</strong> и
          ...
          полагается на догмы. <Link href="/dom">Все условия челленджа — на отдельной
          странице »</Link>
        </p>
      </section>
...
{/* --- Челлендж / выше на странице --- */}
<section style={{ textAlign:'center', margin:'2rem 0' }}>
  <h2>🏠  Челлендж «Докажи шар — получи дом»</h2>
  <p>
    Государство Terra Zetetica запускает самый прозрачный научный вызов: <br/>
